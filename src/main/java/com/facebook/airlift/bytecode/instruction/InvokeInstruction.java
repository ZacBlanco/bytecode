...
import static com.facebook.airlift.bytecode.MethodDefinition.methodDescription;
import static com.facebook.airlift.bytecode.OpCode.INVOKEDYNAMIC;
import static com.facebook.airlift.bytecode.OpCode.INVOKEINTERFACE;
import static com.facebook.airlift.bytecode.OpCode.INVOKESPECIAL;
import static com.facebook.airlift.bytecode.OpCode.INVOKESTATIC;
import static com.facebook.airlift.bytecode.OpCode.INVOKEVIRTUAL;
        ...
        implements InstructionNode
{
    ...
    private static InstructionNode invoke(OpCode invocationType, Method method)
    {
        return new InvokeInstruction(invocationType,
                ...
                ImmutableList.copyOf(method.getParameterTypes()).stream().map(ParameterizedType::type).collect(toImmutableList()));
    }
